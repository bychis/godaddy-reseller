...
class shoppers:
    ...
    def create_subaccount(self, email, nameFirst, nameLast, password):
        req_url = '{}/v1/shoppers/subaccount'.format(self.base_url)
        data = {
            'email': email,
            'externalId': 0,
            'marketId': 'en-US',
    ...
    def get_shopper_details(self, shopperId):
        req_url = '{}/v1/shoppers/{}'.format(self.base_url, shopperId)
    ...
    def delete_shopper(self, shopperId, auditClientIp):
        req_url = '{}/v1/shoppers/{}?auditClientIp={}'.format(
            self.base_url, shopperId, auditClientIp)
